...
# 配置谷歌Gemini API密钥
api_key = 'AIzaSyDiSLFZKJc2RVsW1_21Cdw1FrIPuwGbcsY'
...
def evaluate_responses(question, response_a):
    """评估单个回复的质量
...
def main():
    ...
    # 结果文件
    results_file = "results_indi_a.json"
    ...
    for no in range(start_no, 3489):  # 处理所有3489个问题
        ...
        # 评估回复
        evaluation, error_msg = evaluate_responses(question, response_a)
